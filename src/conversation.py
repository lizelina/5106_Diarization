import pandas as pd
import numpy as np
from src.pyannote_model import diarization_to_dataframe
from src.transcribe import whisper_inference_with_segments_df
...
def wav_to_transcript(wav_fname, model_type, pyannote_token):
    ...
    speaker_df = diarization_to_dataframe(wav_fname, pyannote_token)
    print('done')
